    ...
    <section class="content">
      ...
      <div class="row">
        <?php
            ...
            $colores = Array("red","green","aqua","yellow","fuchsia","danger");
            $indice = 0;
        ?>
        <div class="col-md-12">
            ...
            <div class="col-md-4">
                <div class="small-box bg-<?php echo $colores[$indice];$indice++;?>">
                    ...
                    <a href="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/reporte_de_Presupuestos" class="small-box-footer">Ir a la seccion <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
            </div>
            <?php } ?>
            <?php if($permiso_Presupuestos){?>
            <div class="col-md-4">
                <div class="small-box bg-<?php echo $colores[$indice];$indice++;?>">
                    <div class="inner">
                      <h3>PEDIDOS</h3>
                    ...
                    <a href="<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/registro_de_Presupuestos" class="small-box-footer">Ir a la seccion <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
            </div>
            <?php } ?>
