                       ...
                       <div class="col-md-12" style="text-align: center;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="tipo_editar_perfil" class="form-control" id="tipo_editar_perfil" disabled>
                                <?php 
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="fecha_registro_editar_perfil" id="fecha_registro_editar_perfil" value="<?php echo $mi_perfil["fecha_registro"]?>" disabled/>
                        </div>
                        <div class="col-md-6">
                            <label for="estado_editar_perfil">Estado*</label>
                            <select name="estado_editar_perfil" class="form-control" id="estado_editar_perfil" disabled>
                            <?php 
    ...
    function guardar_cambios()
    {
           ...
           && fecha_registro != "")
        {
            ...
            else
            {
                ...
                $.ajax({
                    url: "<?php echo base_url()?>index.php/<?php echo $controller_usuario?>/actualizar_perfil",
                    type: "POST",
                    contentType: false,
                    data:formdata,
                    processData:false,
