...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Datos <?php echo $titulo_login["valor"]?>
        <!--<small>Control panel</small>-->
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-gears"></i>Datos</a></li>
      </ol>
    </section>
...
<!---->
<div class="modal modal-default modal_editar" id="modal_editar_configuracion">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="col-md-12">
                  <button class="btn btn-default pull-left" onClick="$('#modal_editar_configuracion').modal('hide')"><i class='fa fa-close'></i> Cancelar</button>
                    <button class="btn btn-primary pull-right" onClick="editar_configuracion()"><i class='fa fa-save'></i> Guardar</button>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
