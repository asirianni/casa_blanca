...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modulos de tipo de usuario: <?php echo $tipo_usuario["tipo"]?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-users"></i>MENU DE NAVEGACION</a></li>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <a href="<?php echo base_url()?>index.php/Usuarios/abm_tipos_usuarios" class="btn btn-primary pull-left" ><i class='fa fa-arrow-left'></i></a>
                </div><!-- /.box-header -->
                <div class="box-body">
                        ...
                        <?php 
                            foreach($modulos_existentes as $value)
                            {
                                ...
                                "<tr>
                                    ...
                                    <td>".$value["modulo"]."</td>
                                    <td>
                                        <button class='btn btn-success' id='boton_modulo_".$value["id"]."' onClick='activar_desactivar_modulo(".$value["id"].",".$id_tipo_usuario.")'>Activo</button>
                                    </td>
                                </tr>";
                            }
                            ...
                            foreach($modulos_faltantes as $value)
                            {
                                ...
                                "<tr>
                                    ...
                                    <td>".$value["modulo"]."</td>
                                    <td>
                                        <button class='btn btn-primary' id='boton_modulo_".$value["id"]."' onClick='activar_desactivar_modulo(".$value["id"].",".$id_tipo_usuario.")'>No Activo</button>
                                    </td>
                                </tr>";
                            }
                        ?>
...
<script>
   function activar_desactivar_modulo(id_modulo,id_usuario)
   {
       ...
       {
           $.ajax({
                url: "<?php echo base_url()?>index.php/Usuarios/desactivar_modulo_tipo_usuario",
                type: "POST",
                data:{id_modulo:id_modulo,id_tipo_usuario:id_usuario},
                success: function(data)
                {
                    ...
                    if(data)
                    {
                        ...
                        $("#boton_modulo_"+id_modulo).addClass("btn-primary");
       ...
       {
            $.ajax({
                url: "<?php echo base_url()?>index.php/Usuarios/activar_modulo_tipo_usuario",
                type: "POST",
                data:{id_modulo:id_modulo,id_tipo_usuario:id_usuario},
                success: function(data)
                {
                    ...
                    if(data)
                    {
                       $("#boton_modulo_"+id_modulo).removeClass("btn-primary");
