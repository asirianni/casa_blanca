                    ...
                    <form action="#" method="post" id="formulario_editar_perfil">
                       ...
                       <div class="col-md-12" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php
                                  ...
                                  if($mi_perfil["tipo_usuario"] != 1){$disabled_tipo="disabled";}
                                ?>
                                <select name="tipo_editar_perfil" class="form-control" id="tipo_editar_perfil" <?php echo $disabled_tipo?>>
                                <?php 
                        ...
                        <div class="col-md-6">
                          ...
                          $activar_date_picker="datetimepicker";

                          if($mi_perfil["tipo_usuario"] != 1)
                          {
                            $activar_date_picker="";
                          }
                          ...
                          ?>
                            ...
                            <input type="text" class="form-control <?php echo $activar_date_picker ?>" name="fecha_registro_editar_perfil" id="fecha_registro_editar_perfil" value="<?php echo $mi_perfil["fecha_registro"]?>" readonly="" style="background-color: #fff" <?php echo $disabled_tipo?>/>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="estado_editar_perfil" class="form-control" id="estado_editar_perfil" <?php echo $disabled_tipo?>>
                            <?php 
                        ...
                        <div class="col-md-12" style="text-align:center;margin-top: 20px;">
                            <button onClick="guardar_cambios()" class="btn btn-sm btn-primary"><i class="fa fa-save"></i> Guardar Cambios</button>
                        </div>
                    </form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
