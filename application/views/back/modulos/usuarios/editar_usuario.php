...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Editar Usuario <?php echo $usuario["nombre"]." ".$usuario["apellido"]?>
            ...
            <div class="box" style="margin-top: 10px;">
                <div class="box-body">
                  <form action="#" method="post" id="formulario">
                    <input type="hidden" name="id_editar_usuario" value="<?php echo $usuario["id"]?>">
                        <div class="col-md-12" style="text-align: center;">
                                <img height="200" class="" src="<?php echo base_url()?>recursos/images/foto_perfil/<?php echo $usuario["foto_perfil"]?>">
                        </div>
                       ...
                       <div class="col-md-offset-4 col-md-8" >
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="apellido" id="apellido" value="<?php echo $usuario["apellido"]?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="">
                            ...
                            <input type="text" class="form-control datetimepicker" name="fecha_registro" id="fecha_registro" value="<?php echo $usuario["fecha_registro"]?>" readonly="" style="background-color: #fff"/>
                        </div>
                        ...
                        <div class="col-md-6" >
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="password" name="password" value="<?php echo $usuario["pass"]?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datetimepicker" name="nacimiento" id="nacimiento" readonly="" style="background-color: #fff" value="<?php echo $usuario["nacimiento"]?>"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="edad">Edad</label>
                                <input type="text" class="form-control" name="edad" id="edad" readonly="" value="<?php echo $usuario["edad"]?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ocupacion" id="ocupacion" value="<?php echo $usuario["ocupacion"]?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php
                                  if($usuario["id_localidad"] > 0)
                                  {
                                    echo "<option value='".$usuario["id_localidad"]."'>".$usuario["localidades_localidad"]."</option>";
                                  }
                                ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="movil" id="movil" value="<?php echo $usuario["movil"]?>"/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {
                                    if($usuario["tipo_usuario"]==$value["id"]){
    ...
    function guardar_cambios()
    {
           ...
           && fecha_registro != "")
        {
            ...
            else
            {
                ...
                $.ajax({
                    url: "<?php echo base_url()?>index.php/Usuarios/editar_usuario",
                    type: "POST",
                    contentType: false,
                    data:formdata,
                    processData:false,
